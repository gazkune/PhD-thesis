...
\begin{enumerate}
 ...
 \item To conclude, Section \ref{sec:evaluation:discussion} discusses the results and compares them with the objectives identified in the beginning of this dissertation (Chapter \ref{cha:introduction}). % Discussion: discuss the results.
\end{enumerate}
