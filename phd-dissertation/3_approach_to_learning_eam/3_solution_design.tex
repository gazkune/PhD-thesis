...
\begin{enumerate}
 ...
 \item Sensor activations dataset: as defined in definition \ref{def-sa-dataset}, an unlabelled timestamped sensor activations dataset with the activity traces of a concrete user.
\end{enumerate}
