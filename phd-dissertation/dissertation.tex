...
\ifpdf  
  \hypersetup{pdfinfo={
    Title={Learning for Dynamic and Personalised Knowledge-Based Activity Models},
    Author={Gorka Azkune},
    CreationDate={D:20150324},  %format D:YYYYMMDDhhmmss
    Subject={Artificial Intelligence},
    Keywords={Activity recognition, Machine learning, Knowledge-based models}
}}
\fi
...
\input{1_introduction/0_index}
\input{1_introduction/1_context}
%\input{1_introduction/2_motivation}
\input{1_introduction/3_hypothesis}
\input{1_introduction/3b_methodology.tex}
\input{1_introduction/4_contributions}
\input{1_introduction/5_outline}


%: ----------------------- related work ------------------------

\input{2_state_of_the_art/0_index}
\input{2_state_of_the_art/1_basic_concepts}
\input{2_state_of_the_art/2_datadriven}
\input{2_state_of_the_art/3_knowledgedriven}
\input{2_state_of_the_art/4_hybrid}
\input{2_state_of_the_art/5_summary}

%: ---------- the approach to learn complete and specialised activity models ------------------------
% Think about a better title!

\input{3_approach_to_learning_eam/0_index}
\input{3_approach_to_learning_eam/1_ontology}
\input{3_approach_to_learning_eam/2_definitions}
\input{3_approach_to_learning_eam/3_solution_design}
\input{3_approach_to_learning_eam/4_summary}

%: ----------------------- clustering process ------------------------
\input{4_clustering_process/0_index}
\input{4_clustering_process/1_sa3}
\input{4_clustering_process/2_activity_clustering}
\input{4_clustering_process/3_summary}


%: ----------------------- activity model learner ------------------------
\input{5_activity_model_learner/0_index}
\input{5_activity_model_learner/1_objectives}
\input{5_activity_model_learner/2_relevant_information}
\input{5_activity_model_learner/3_learning_algorithm}
\input{5_activity_model_learner/4_summary}



%: ----------------------- Evaluation ------------------------

\input{6_evaluation/0_index}
\input{6_evaluation/1_methodology}
\input{6_evaluation/2_scenarios}
%\input{6_evaluation/3_results}
\input{6_evaluation/4_discussion}


%: ----------------------- conclusion ------------------------

\input{7_conclusions/0_index}
\input{7_conclusions/1_conclusions}
\input{7_conclusions/2_contributions}
\input{7_conclusions/3_hypo_validation}
\input{7_conclusions/3_publications}
\input{7_conclusions/4_future_work}
\input{7_conclusions/5_final_remarks}
