...
This experiment will test the activity model learner in realistic scenarios, combining missing sensors (use Chen's analysis to establish values per sensor type), positive sensor noise (estimate it) and challenging activity patterns
